...
uses
  ...
  f_ttg_avalon in 'f_ttg_avalon.pas' {frm_ttg_dabs},
  ...
  f_input_promo_diskon in 'f_input_promo_diskon.pas' {frm_input_promo_diskon},
  f_lihat_promo_diskon in 'f_lihat_promo_diskon.pas' {frm_lihat_promo_diskon};
...
begin
  ...
  Application.CreateForm(Tfrm_ttg_dabs, frm_ttg_dabs);
  ...
  Application.CreateForm(Tfrm_input_promo_diskon, frm_input_promo_diskon);
  Application.CreateForm(Tfrm_lihat_promo_diskon, frm_lihat_promo_diskon);
  Application.Run;
