...
type
  Tfrm_utama = class(TForm)
    ...
    procedure LihatPromoDiskon1Click(Sender: TObject);
...
uses f_login, f_koneksi, f_lihat_pengeluaran, f_input_pengeluaran,
  ...
  f_lap_brankas_periode, f_lihat_promo_diskon, f_input_promo_diskon;
...
begin
  ...
  {    if (frm_login.lbl_level.Caption)='OWNER' then
      begin
        frm_lap_pengeluaran_berdasarkan.cmb_harian.Visible:=true;
      end
      else
      begin
        frm_lap_pengeluaran_berdasarkan.cmb_harian.Visible:=false;
      end;         }
      kosong;
      showmodal;
    end;
...
procedure Tfrm_utama.LihatPromoDiskon1Click(Sender: TObject);
begin
  tutupk;
...
procedure Tfrm_utama.InputPromoDiskon1Click(Sender: TObject);
begin
  tutupk;
  frm_lihat_promo_diskon.baref;
  f_input_promo_diskon.kebenaran:= true;
